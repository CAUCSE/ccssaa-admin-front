...
import type { ReportedComment } from "@/types/report"
...
export function ReportedCommentsTable({
  data,
  currentPage,
  totalPages,
  totalElements,
              ...
              <Table className="min-w-[860px]">
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="text-left">댓글 내용</TableHead>
                  ...
                  {data.map((item, index) => (
                    <TableRow key={item.reportId}>
                      ...
                      <TableCell className="max-w-[320px]">
                        <span className="block truncate">{item.commentContent}</span>
                      </TableCell>
